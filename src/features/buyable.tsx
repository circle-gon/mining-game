...
export function createBuyable<T extends BuyableOptions>(
  ...
  return createLazyProxy(() => {
    ...
    if (
      buyable.canPurchase == null &&
      (buyable.resource == null || buyable.cost == null)
    ) {
      console.warn(
    ...
    if (buyable.canPurchase == null) {
      buyable.canPurchase = computed(
        () =>
          unref((buyable as GenericBuyable).visibility) ===
            Visibility.Visible &&
    ...
    const classes = buyable.classes as
    ...
    buyable.onClick = buyable.purchase =
      ...
      function (this: GenericBuyable) {
        ...
        if (genericBuyable.cost != null && genericBuyable.resource != null) {
          ...
          genericBuyable.amount.value = Decimal.add(
            genericBuyable.amount.value,
            1
          );
        }
