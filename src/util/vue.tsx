...
export function render(
  object: VueFeature | CoercableComponent
...
export function renderRow(
  ...objects: (VueFeature | CoercableComponent)[]
): JSX.Element {
...
export function renderRowJSX(
  ...objects: (VueFeature | CoercableComponent)[]
): JSX.Element {
  return <Row>{objects.map(renderJSX)}</Row>;
}

export function renderColJSX(
  ...objects: (VueFeature | CoercableComponent)[]
): JSX.Element {
...
export function isCoercableComponent(
  component: unknown
...
>(
  ...
  const filteredFeatures = computed(() =>
    features.filter(
      (feature) =>
        unref(feature.visibility) === Visibility.Visible && filter(feature)
    )
  );
  return {
...
export function computeOptionalComponent(
  component: Ref<
    ProcessedComputable<CoercableComponent | undefined> | undefined
  >,
  defaultWrapper = "div"
...
export function processedPropType<T>(
  ...types: PropTypes[]
