 ...
 */
export const RegisterNodeInjectionKey: InjectionKey<
 ...
 */
export const NodesInjectionKey: InjectionKey<
 ...
 */
export const BoundsInjectionKey: InjectionKey<Ref<DOMRect | undefined>> =
  Symbol("Bounds");
...
export interface BaseLayer {
  ...
  emit: <K extends keyof LayerEvents>(
